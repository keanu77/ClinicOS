...
export const PermissionCategories: Record<string, { label: string; permissions: Permission[] }> = {
  ...
  assets: {
    label: '設備管理',
    permissions: [Permission.ASSETS_VIEW, Permission.ASSETS_REPORT_FAULT, Permission.ASSETS_MANAGE],
  },
  procurement: {
    label: '採購管理',
    permissions: [
  ...
  quality: {
    label: '醫療品質',
    permissions: [Permission.QUALITY_VIEW, Permission.QUALITY_REPORT, Permission.QUALITY_MANAGE],
  },
  documents: {
    label: '文件制度',
...
export const PermissionRequestStatusLabels: Record<PermissionRequestStatus, string> = {
